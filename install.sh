...
docker exec -it cli peer chaincode install -n mycc -p github.com/chaincode/src/marksheet -v v0
docker exec -it cli peer chaincode instantiate -o orderer0.uni.com:7050 -C mychannel -n mycc github.com/chaincode/src/marksheet -v v0 -c '{"Args": []}'
# -P "OR ('UniversityMemberMSP.peer','PublicMemberMSP.peer')"
...
peer chaincode install -n mycc -p github.com/chaincode/src/marksheet -v v0
