...
docker exe  c -e "CORE_PEER_LOCALMSPID=UniversityMemberMSP" -e "CORE_PEER_MSPCONFIGPATH=/var/hyperledger/users/Admin@universitymember.uni.com/msp" peer0.universitymember.uni.com peer channel create -o orderer0.uni.com:7050 -c mychannel -f /var/hyperledger/configs/channel.tx
